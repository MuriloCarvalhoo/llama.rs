...
`/sys/bus/pci/devices/<pci>/drm/card*/`; com o monitor em repouso (o DisplayPort passa a
`disconnected` em todas) vale 2 GiB nas duas. Depois da carga a margem é conferida de novo e, se
