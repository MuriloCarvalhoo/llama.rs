...
#[allow(dead_code)]
pub(crate) const KV_PACK_SPV: &[u8] = include_bytes!(concat!(env!("KV_PACK_SPV")));
#[allow(dead_code)]
...
#[allow(dead_code)]
pub(crate) const MUL_MM_SPV: &[u8] = include_bytes!(concat!(env!("MUL_MM_SPV")));
pub(crate) const MUL_MM_Q4K_SPV: &[u8] = include_bytes!(concat!(env!("MUL_MM_Q4K_SPV")));
#[allow(dead_code)]
